...
4. Remove tokens, local usernames, private paths, model weights, and other
   sensitive or restricted information from logs and attachments.
...
Maintainers prioritize reproducible defects in supported components, release
integrity, and corrections to published evidence. Experimental scripts and
